...
const styles = [
  ...
  { id: "dress", name: "Dress", icon: "✨", desc: "Refined elegance" },
  { id: "sport", name: "Sport", icon: "🏃", desc: "Active lifestyle" },
  { id: "luxury", name: "Luxury", icon: "👑", desc: "Ultimate luxury" },
];

export default function WomenCollection({ onProductClick }) {
  ...
  const filtered = selected === "all" ? womenWatches : womenWatches.filter(w => w.style === selected);
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-14 animate-fade-up">
          <h1 className="font-display text-5xl sm:text-6xl font-bold text-white mb-4">
            Women's <span className="bg-gradient-to-r from-[#C9A84C] to-[#F0D080] bg-clip-text text-transparent">Collection</span>
          </h1>
          <p className="text-white/50 text-lg max-w-2xl">
            Refined elegance meets precision engineering. Watches crafted for the modern woman.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-5">
          {sorted.map((w, i) => {
            ...
            return (
              ...
              >
                <div className="h-48 bg-gradient-to-br from-[#F472B6]/15 via-[#C9A84C]/10 to-transparent flex items-center justify-center relative overflow-hidden">
                  <WatchImage
                    src={w.image}
                    alt={w.name}
                ...
                <div className="p-5">
                  ...
                  <p className="text-[#F472B6] text-xs font-semibold mb-3 tracking-wider">{w.feature}</p>
                    ...
                    <button
                      ...
                      className={`w-9 h-9 rounded-full flex items-center justify-center transition-all duration-300 ${
                        addedToCart === w.id
                          ...
                          : "bg-[#F472B6]/15 border border-[#F472B6]/30 hover:bg-[#F472B6]/25"
                      }`}
                    >
                      {addedToCart === w.id ? (
