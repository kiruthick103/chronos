...
const USER_EMAIL = "userdemo@gmail.com";
...
export default function Login({ setPage }) {
  ...
  const handleDemoLogin = async (role) => {
    ...
    const demoEmail = role === "admin" ? ADMIN_EMAIL : USER_EMAIL;
    const demoPassword = role === "admin" ? ADMIN_PASSWORD : USER_PASSWORD;
          ...
          <div className="mb-6 space-y-3">
            ...
            <div className="rounded-xl border border-emerald-500/25 bg-emerald-500/5 p-4">
              <div className="flex items-start gap-3">
                <div className="mt-0.5 w-7 h-7 rounded-full bg-emerald-500/15 flex items-center justify-center flex-shrink-0">
